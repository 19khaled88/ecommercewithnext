                    ...
                    <div className="ui equal width form">
                      <div className="fields">
                        <div className="field">
                          ...
                          <input type="text" onChange={(e)=>setCategory(e.target.value)} defaultValue={singleData.category} />
                        </div>
                        <div className="field">
                          <label>Name</label>
                          <input type="text" onChange={(e)=>setTitle(e.target.value)} defaultValue={singleData.title}/>
                        </div>
                      </div>
                      <div className="fields">
                        ...
                        <div className="field">
                          <label>Price</label>
                          <input type="number" onChange={(e)=>setPrice(e.target.value)} defaultValue={singleData.price} />
                        </div>
                        <div className="field">
                          <label>Stock</label>
                          <input type="number" onChange={(e)=>setStock(e.target.value)} defaultValue={singleData.inStock}/>
                        </div>
                      </div>
                      <div className="fields">
                      ...
                      <div className="field">
                          ...
                          <textarea type="text" onChange={(e)=>setDescription(e.target.value)} defaultValue={singleData.description}/>
                        </div>
