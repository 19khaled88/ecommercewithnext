...
const AddPage = () => {
  ...
  const [ProductCategory, setProductCategory] = useState('desktop')
 ...
 const CLOUD_NAME='be-fresh-ltd'
  ...
  const formHandler=async(e)=>{
    ...
    if(url && public_id){
      const res = await postData('products', productData)
        ...
        <form onSubmit={formHandler} className="ui form">
          ...
          <div className="two fields">
            ...
            <div className="field">
              ...
              <div className="ui input">
              <select value={ProductChecked} onChange={(e) => setProductChecked(e.target.value)}>
          ...
          <div className="field">
              ...
              {
                createObjectURL ? <Image width={400} height={300} src={createObjectURL} alt="" />:''
              }
          ...
          <div className="two fields">
            ...
            <div className="field">
              <label>Sold</label>
              <div className="ui input">
                <select value={ProductSold} onChange={(e)=>setProductSold(e.target.value)}>
                <option value="0">Sold out</option>
                <option value="1">Not sold out</option>
                </select>
              </div>
            </div>
          </div>
